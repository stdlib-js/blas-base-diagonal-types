...
```javascript
diagonalTypes = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-diagonal-types@v0.0.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-diagonal-types@v0.0.1-umd/browser.js"></script>
```
