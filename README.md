...
```javascript
import diagonalTypes from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-diagonal-types@v0.0.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { enum } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-diagonal-types@v0.0.0-deno/mod.js';
```
